...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        (tab1.findViewById(R.id.tabIcon)).setBackgroundResource(R.drawable.view_details);
        ...
        (tab2.findViewById(R.id.tabIcon)).setBackgroundResource(R.drawable.user_add);
        ...
        (tab3.findViewById(R.id.tabIcon)).setBackgroundResource(R.drawable.user_profile);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position){
                ...
                case 1 :
                    SecondTabFragment second = new SecondTabFragment();
                    return second;
